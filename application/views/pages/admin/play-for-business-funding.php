    ...
    <div class="page-wrapper">
        <div class="page-header">
            <div class="page-header-title">
                <h4>Daily Business Funding Play</h4>
            </div>
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('admin/business-funding');?>">Play For Business Funding</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-xl-12">
				    <div class="card">
                        <div class="card-header">
                            <h5>Daily Draw Play For Business Funding</h5>
                        </div>
                        <?php
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" id="button5" class="btn btn-primary">Win</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal fade" id="loser" tabindex="-1">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" id="button6" class="btn btn-primary">Loss</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = '<?php echo base_url('admin/business-funding');?>';
        $('#button5').click(function() {
            ...
            $.post({
                url: '<?php echo base_url('admin/business-funding/win');?>',
                data: send_data,
                error: function() {
        ...
        $('#button6').click(function() {
            ...
            // console.log(send_data);
            $.post({
                url: '<?php echo base_url('admin/business-funding/loss');?>',
                data: send_data,
                error: function() {
                  // alert('Something is wrong');
                },
